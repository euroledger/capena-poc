...
const config = {
    ...
    // Change to your endpoint blockchain's ledger endpoint
    blockchainLedgerEndPoint: process.env.BLOCKCHAIN_LEDGER_ENDPOINT,
    ...
    userInformation: {
        ...
        icon_front: process.env.ICON_FRONT || '/images/sovrinIcon.png',
